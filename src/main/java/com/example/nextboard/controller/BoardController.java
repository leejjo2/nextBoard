...
public class BoardController {
    ...
    public void editBoard(@RequestPart(value = "board") Board board, @RequestPart(value = "file", required = false) MultipartFile file) {
        ...
        long sysTime = System.currentTimeMillis();
        boardService.editFile(file, exFilePath, sysTime);
        boardService.editBoard(exBoard, sysTime, file);
    }
